...
loom {
    forge {
        ...
        mixinConfig(
            "hex_expanded-common.mixins.json",
            "hex_expanded-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("hex_expanded.apply-datagen-mixin", "true")
                property("hex_expanded.$platform-datagen", "true")
            }
        }
    }
}

hex_expandedModDependencies {
