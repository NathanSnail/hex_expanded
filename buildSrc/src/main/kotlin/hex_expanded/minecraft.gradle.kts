...
package hex_expanded

import kotlin.io.path.div
import libs

plugins {
    id("hex_expanded.java")
...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hex_expanded.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hex_expanded-common-common-refmap.json
        // fixed:   hex_expanded-common.refmap.json
